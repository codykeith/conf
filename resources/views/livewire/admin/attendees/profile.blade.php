<div class="bg-white shadow overflow-hidden sm:rounded-lg">
	<div class="px-2 py-5 sm:px-6 flex justify-between content-center">
		<div>
		...
		<div>
			...
			<img class="inline-block h-10 w-10 rounded-full ring-2 ring-white ml-4" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
		</div>
	</div>
